...
object ActorModel {
  ...
  //ken add
  case class CMDeleteTopicc(offsetPath:String,offset:Long) extends CommandRequest
  case class CMDelConsumerGroup(consumerGroup:String) extends CommandRequest
  case class CMResetConsumerGroup(consumerGroup:String,topic:String,topicInfo:String) extends CommandRequest
  ...
  //ken add
  case class KCDeleteTopicc(offsetPath: String,offset:Long) extends CommandRequest
  case class KCDelConsumerGroup(consumerGroup: String) extends CommandRequest
  case class KCResetConsumerGroup(consumerGroup: String,topic: String,topicInfo: String) extends CommandRequest
